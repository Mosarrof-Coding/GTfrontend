...
// const socket = io("https://g-backend-ut3w.onrender.com");
...
//   return (
//     <div className="fixed bottom-16 right-4 border-t-4 z-[999] border-teal-600 bg-white rounded-lg shadow-lg w-80 flex flex-col min-h-36 max-h-60 p-4">
