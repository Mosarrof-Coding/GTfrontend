...
export default function Product_details() {
  ...
  const p_name = data?.attributes.name;
        ...
        <div className="">
          <div className="contizer grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-6 md:gap-4 lg:gap-6 xl:gap-10">
                  ...
                  <div>
                    {activeTab === "description" && (
                      <p className="description">
                        ...
                        elit. Dolores, ab vel explicabo culpa, aperiam
                        distinctio doloremque voluptatum nisi voluptatem
                        deserunt voluptas porro, sed voluptatibus. Ea minus
                        tempora iure, delectus deserunt debitis ut corrupti
                        consequuntur! Aspernatur laborum laudantium, neque
                        soluta atque a assumenda error praesentium dolorum
                        temporibus inventore tempore ut sunt aliquid molestiae,
                        illum deserunt eaque provident fugit iure quam veniam.
                      </p>
                    )}
                    {activeTab === "review" && (
            ...
            <div className="col-span-6 md:col-span-4 order-1 md:order-2">
              {/* Categories */}
              <ul className="Categorie mt-2 bg-white rounded-lg overflow-hidden">
                <h3 className="bg-black text-white text-lg lg:text-xl font-medium px-4 py-2 xl:py-2.5 border-b relative">
                  Categories
                </h3>
                {Object.entries(categoryCounts).map(([categoryName, count]) => (
                  <li
                    className="text-sm sm:text-base border-b px-4 py-1 lg:py-1.5 flex items-center justify-between"
                    key={categoryName}
                  >
