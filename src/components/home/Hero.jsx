    ...
    <section className="bg-black/10 relative">
      ...
      <div className="absolute left-0 top-0 right-0 bottom-0 grid place-items-center px-[15px]">
        <div className="mx-auto max-w-[800px] text-center flex flex-col justify-between gap-2 md:flex-none py-4">
          <div>
            <h2 className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-4xl font-semibold  text-white leading-none">
            ...
            <p className="mt-1 sm:mt-2 lg:mt-4 lg:px-16 text-gray-200 text-sm md:text-lg lg:text-xl font-normal leading-[1] md:leading-normal tracking-tight">
          ...
          <Link
            to=""
            className="w-fit mx-auto mt-4 sm:mt-12 md:mt-16 rounded bg-red-600 px-4 md:px-6 lg:px-8 py-1 md:pt-2 lg:py-3 text-xs lg:text-sm font-medium text-white shadow hover:bg-red-700 focus:outline-none focus:ring active:bg-red-500 leading-none"
          >
            SHOPE NOW
          </Link>
        </div>
